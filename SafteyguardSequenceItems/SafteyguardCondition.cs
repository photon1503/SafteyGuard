...
namespace Photon.NINA.SafteyGuard.SafteyguardTestCategory {
    ...
    public class SafteyguardCondition : SequenceCondition {
        /// <summary>
        ...
        public override object Clone() {
            return new SafteyguardCondition() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(SafteyguardCondition)}, IsTruthy: {IsTruthy}";
        }
    }
}