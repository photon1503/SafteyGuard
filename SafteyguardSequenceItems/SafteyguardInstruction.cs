...
namespace Photon.NINA.SafteyGuard.SafteyguardTestCategory {
    /// <summary>
    ...
    [ExportMetadata("Category", "SafteyGuard")]
    [Export(typeof(ISequenceItem))]
    [JsonObject(MemberSerialization.OptIn)]
    public class SafteyguardInstruction : SequenceItem {
        /// <summary>
        ...
        public SafteyguardInstruction() {
            Text = Settings.Default.DefaultNotificationMessage;
        }
        public SafteyguardInstruction(SafteyguardInstruction copyMe) : this() {
            CopyMetaData(copyMe);
        }
        ...
        public override object Clone() {
            return new SafteyguardInstruction(this);
        }
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(SafteyguardInstruction)}, Text: {Text}";
        }
    }
}