...
namespace Photon.NINA.SafteyGuard.SafteyguardTestCategory {
    ...
    public class SafteyguardTrigger : SequenceTrigger {
        /// <summary>
        ...
        public SafteyguardTrigger() {
        }

        public override object Clone() {
            return new SafteyguardTrigger() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(SafteyguardTrigger)}";
        }
    }
}